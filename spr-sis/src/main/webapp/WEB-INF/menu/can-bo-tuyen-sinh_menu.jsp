...
<ul class="main-navigation">
	...
	<li><a href="#" id="labelMenu"><spring:message
				code="label.menu.major"></spring:message></a>
		<ul class="dropdown-menu" aria-labelledby="dropdownMenu1"
			style="background: #1bc2a2; margin: 0px;">
			<li><a
				href="${pageContext.request.contextPath }/nghiep-vu/quan-ly-ho-so-du-tuyen"
				id="labelMenu"><spring:message code="label.menu.major.QLyHSSV"></spring:message></a></li>
		</ul></li>
